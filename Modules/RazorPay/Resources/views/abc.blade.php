...
<body>
    ...
    <div class="container clear">
        <div class="panel-body" style="border: 1px solid var(--border_color);padding: 10px;background: #eee;width: 30%;">
            <form id="rzp-footer-form" action="{!!route('razorpay/dopayment')!!}" method="POST" style="width: 100%; text-align: center" >
                @csrf
